...
REM 配置文件
adb push trime.custom.yaml /sdcard/rime2
@REM adb push moqi_xh-trime.custom.yaml /sdcard/rime2
@REM adb push moqi_xh-trime.schema.yaml /sdcard/rime2
adb push moqi_xh-18key.schema.yaml /sdcard/rime2
adb shell rm /sdcard/rime2/build/shouxin_18key.trime.yaml
